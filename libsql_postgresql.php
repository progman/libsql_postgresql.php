...
function libsql__var2text_list($item_list)
function libsql__var2bytea($item)
function libsql__var2bytea_list($item_list)
function libsql__var2bigint($item)
function libsql__var2bigint_list($item_list)
function libsql__var2bool($item)
function libsql__var2bool_list($item_list)
function libsql__var2json($item)
function libsql__var2json_list($item_list)
